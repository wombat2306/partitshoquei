...
<div className="border-b border-gray-200 px-4 py-3 w-full">
  ...
  <div className="grid grid-cols-7 gap-2 items-center">
    <div>
      <span className="text-xs text-gray-600">p.jug</span>
      <div className="text-sm items-center">{filaClasificacion.pjugados}</div>
    </div>

    <div>
      <span className="text-xs text-gray-600">p.gan</span>
      <div className="truncate">{filaClasificacion.pganados}</div>
    </div>

    <div>
      <span className="text-xs text-gray-600">p.emp</span>
      <div className="truncate">{filaClasificacion.pempatados}</div>
    </div>

    <div>
      <span className="text-xs text-gray-600">p.per</span>
      <div className="truncate">{filaClasificacion.pperdidos}</div>
    </div>

    <div>
      <span className="text-xs text-gray-600">g.fav</span>
      <div className="truncate">{filaClasificacion.gfavor}</div>
    </div>

    <div>
      <span className="text-xs text-gray-600">g.con</span>
      <div className="truncate">{filaClasificacion.gcontra}</div>
    </div>

    <div>
      <span className="text-xs text-gray-600">san</span>
